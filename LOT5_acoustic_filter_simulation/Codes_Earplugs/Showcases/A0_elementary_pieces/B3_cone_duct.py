...
if __name__ == "__main__":
    ...
    cone_discret = successive_cone_approx(r_inlet, r_out_cone, length_duct, n_sub=100, c0=C0, rho0=RHO0)

    straight_duct = CylindricalDuct(radius=r_inlet, length=length_duct, c0=C0, rho0=RHO0)

    section_junction_expansion = ImpedanceJunction(s_duct_out, s_out, rho0=RHO0, end_correction=True)

    system_air_only = inlet + straight_duct + outlet
    system_filter = inlet  + cone_discret + section_junction_expansion + outlet

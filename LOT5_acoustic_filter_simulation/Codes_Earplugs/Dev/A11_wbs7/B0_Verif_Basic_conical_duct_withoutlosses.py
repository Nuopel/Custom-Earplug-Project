...
if __name__ == "__main__":
    ...
    r2 = 2e-2
    P_INCIDENT = 1.0
    FEM_FILE = HERE / "fem_rslt" / "rslt_fem_cone_lossless.txt"
    ...
    plot_matrix_comparison(
        ...
        matrix_fem,
        mode="abs_phase",
        title_prefix="Circular duct without losses: transfer matrix comparison",
    )
    plt.show()
    ...
    #
    r_tmm, t_tmm, a_tmm = system_exact.reflection_transmission_absorption_unequal_refs(Z_in=z0_in,Z_out=z0_out, omega=omega, k_ref=k0, length=total_length)
    ...
    plot_end_pressures(
        ...
        p_end_rigid_fem,
        p_end_open_fem,
        title_prefix="Circular duct without losses: end pressure comparison",
    )
    plt.show()
    #
    plot_rta_comparison(
        ...
        t_fem_tm,
        a_fem_tm,
        title_prefix="Circular duct without losses: R/T/A comparison",
    )
    plt.show()

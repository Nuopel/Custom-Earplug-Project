...
from toolkitsd.acoustmm import CylindricalDuct, WaveguideElement, FrozenMatrixElement, GeometryConfig, RadiationImpedance, ThreeMicPostProcessor

OPEN_PATH = VERIF_DIR / "same_radius_air_air_open.txt"
RIGID_PATH = VERIF_DIR / "same_radius_air_air_rigidend.txt"
